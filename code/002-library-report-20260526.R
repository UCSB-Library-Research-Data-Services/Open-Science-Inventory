...
## set up svg export
svglite::svglite("images/library-report-light-20260526.svg", width = 7, height = 10)
...
## set up svg export
svglite::svglite("images/library-report-gray-20260526.svg", width = 7, height = 10)
...
##dev.copy(png, "images/library-report-20260520.png",
